...
# 5 "C:/Users/nauma/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8\\pic\\include\\builtins.h" 2 3
...
# 53 "./mcc_generated_files/i2c2_slave.h"
...
# 124 "./mcc_generated_files/ccp1.h"
void CCP1_Initialize(void);
# 140 "./mcc_generated_files/ccp1.h"
void CCP1_CaptureISR(void);
# 181 "./mcc_generated_files/ccp1.h"
...
# 1 "./mcc_generated_files/../mssp2_client.h" 1
# 62 "./mcc_generated_files/../mssp2_client.h"
...
# 80 "./mcc_generated_files/../mssp2_client.h"
    void assignMSSPByteWriteHandler(void (*writeHandler)(uint8_t));
# 91 "./mcc_generated_files/../mssp2_client.h"
    void assignMSSPByteReadHandler(uint8_t (*readHandler)(void));
# 100 "./mcc_generated_files/../mssp2_client.h"
    ...
    while (1)
    {
        if(time == 1)
        {
            ...
            if((percent >= 0.25) && (percent < 0.50))
                ...
                duty = (uint16_t)(((float)0x140)*percent) + 0x2F;
            ...
            else
            {
                ...
                if((uint16_t)fabsf(temp_ctrl.result) > duty) temp_ctrl.result = (float)(duty);
                PWM5_LoadDutyValue((uint16_t)fabsf(temp_ctrl.result));
            }
