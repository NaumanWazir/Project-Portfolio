...
uint8_t on_time1 = 4;
uint8_t on_time2 = 4;
uint8_t on_time1_update = 4;
uint8_t on_time2_update = 4;
uint8_t enableServo = 0;
uint8_t ir_state = 0;
uint8_t count1 = 0;
uint8_t count2 = 0;
uint8_t lastposition = 4;
char msg[20];
void Timer1_start()
{
    T1CONbits.RD16 = 1;
...
int main(void)
{
    ...
    while(1)
    {
        ...
        if(enableBuzzer)
        {
            ...
            if (BuzzerCounter == 0.5*100)
                LATAbits.LATA2 = 1;
            if (BuzzerCounter == 2*0.5*100)
            {
                LATAbits.LATA2 = 0;
                BuzzerCounter = 0;
                enableBuzzer = 0;
