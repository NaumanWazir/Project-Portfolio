# 1 "mcc_generated_files/bootloader/library/core/bl_app_verify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2
# 31 "mcc_generated_files/bootloader/library/core/bl_app_verify.c"
...
# 31 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\include\\c99\\stdbool.h" 1 3
# 32 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2

# 1 "mcc_generated_files/bootloader/library/core/bl_app_verify.h" 1
# 35 "mcc_generated_files/bootloader/library/core/bl_app_verify.h"
...
# 35 "mcc_generated_files/bootloader/library/core/bl_app_verify.h" 2
# 46 "mcc_generated_files/bootloader/library/core/bl_app_verify.h"
bl_result_t BL_ImageVerify(void);
# 33 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2

# 1 "mcc_generated_files/bootloader/library/core/bl_config.h" 1
# 34 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2

# 1 "mcc_generated_files/bootloader/library/core/../../../nvm/nvm.h" 1
# 36 "mcc_generated_files/bootloader/library/core/../../../nvm/nvm.h"
...
# 36 "mcc_generated_files/bootloader/library/core/../../../nvm/nvm.h" 2
...
# 35 "mcc_generated_files/bootloader/library/core/bl_app_verify.c" 2
...
static bl_result_t ChecksumValidate(flash_address_t startAddress, uint32_t length, flash_address_t checkAddress)
{
    ...
    _Bool refAddrInsideEvaluatedArea = (((checkAddress + 1U) >= startAddress) && (checkAddress < (startAddress + length)));
    _Bool refAddrOutsideFlash = ((checkAddress + 1U) >= (0x8000U));

    if ((length == 0U) || ((startAddress + length) > (0x8000U)))
    {
...
bl_result_t BL_ImageVerify(void)
{
    ...
    result = ChecksumValidate((0x3000), (((((uint32_t)(0x8000U) - (uint32_t)1U) - (uint32_t)2U) + (uint32_t)1U) - (uint32_t)(0x3000)), ((((uint32_t)(0x8000U) - (uint32_t)1U) - (uint32_t)2U) + (uint32_t)1U));
